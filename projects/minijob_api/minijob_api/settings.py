"""
Django settings for minijob_api project.
...
SECRET_KEY = 'django-insecure-#mh(c@6$refn1h7swp0k@h+w25()l8mz-qj%$ax-)fz+0+^oey'
...
WSGI_APPLICATION = 'minijob_api.wsgi.application'
